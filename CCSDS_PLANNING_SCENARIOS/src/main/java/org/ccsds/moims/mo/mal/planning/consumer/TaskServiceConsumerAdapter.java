...
public class TaskServiceConsumerAdapter extends TaskAdapter {
	
	public static final Logger LOGGER = Logger
			.getLogger(TaskServiceConsumerAdapter.class.getName());
	private String name;
	
	public TaskServiceConsumerAdapter(String name) {
		this.name = name;
	}
	...
	public void addDefinitionResponseReceived(MALMessageHeader msgHeader,
		...
		super.addDefinitionResponseReceived(msgHeader, _LongList0, qosProperties);
	}
