...
/**
 * ProcedureExecution service consumer.
 * @author krikse
 *
 */
public class ProcedureExecutionServiceConsumer {

	public static final Logger LOGGER = Logger
			.getLogger(ProcedureExecutionServiceConsumer.class.getName());
	...
	public ProcedureExecutionServiceConsumer(String consumerName) {
	...
	public void stop() throws MALException, MALInteractionException {
		if (procedureExecutionService != null) {
