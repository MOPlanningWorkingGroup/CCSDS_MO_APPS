 ...
 *
 */
public class ProcedureDefinitionServiceListener implements MALPublishInteractionListener {
	
	public static final Logger LOGGER = Logger.getLogger(ProcedureDefinitionServiceListener.class.getName());
