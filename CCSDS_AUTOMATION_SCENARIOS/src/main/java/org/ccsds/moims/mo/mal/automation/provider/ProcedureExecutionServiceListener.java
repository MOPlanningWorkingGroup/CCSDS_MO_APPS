 ...
 *
 */
public class ProcedureExecutionServiceListener implements MALPublishInteractionListener {
	
	public static final Logger LOGGER = Logger.getLogger(ProcedureExecutionServiceListener.class.getName());
