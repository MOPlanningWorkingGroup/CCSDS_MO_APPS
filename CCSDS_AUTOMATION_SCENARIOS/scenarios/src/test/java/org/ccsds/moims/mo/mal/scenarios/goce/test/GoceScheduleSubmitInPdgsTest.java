...
public class GoceScheduleSubmitInPdgsTest extends JbpmJUnitBaseTestCase {
	...
	private static final Logger logger = LoggerFactory
			.getLogger(GoceScheduleSubmitInPdgsTest.class);
	...
	public void init() throws Exception {
		logger.info("Loading goce_schedule_service_pdgs.bpmn");
		runtimeManager = getRuntimeManager(
				"org/ccsds/moims/mo/mal/scenarios/goce/goce_schedule_service_pdgs.bpmn");
