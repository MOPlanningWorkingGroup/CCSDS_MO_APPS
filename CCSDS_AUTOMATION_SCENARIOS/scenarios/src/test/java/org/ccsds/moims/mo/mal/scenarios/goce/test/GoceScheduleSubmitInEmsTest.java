...
public class GoceScheduleSubmitInEmsTest extends JbpmJUnitBaseTestCase {
	
	private static final Logger logger = LoggerFactory
			.getLogger(GoceScheduleSubmitInEmsTest.class);
	...
	public void init() throws Exception {
		logger.info("Loading goce_schedule_service_ems.bpmn");
		runtimeManager = getRuntimeManager(
				"org/ccsds/moims/mo/mal/scenarios/goce/goce_schedule_service_ems.bpmn");
